...
func NewRedisCache(redis IRedis.RedisConnection, prefix string) ICache.CacheStore {
	return &RedisStore{
		redis:  redis,
		prefix: prefix,
	}
...
func (this *RedisStore) Remember(key string, ttl time.Duration, provider IContainer.InstanceProvider) interface{} {
	result := this.Get(key)
...
func (this *RedisStore) RememberForever(key string, provider IContainer.InstanceProvider) interface{} {
