...
import (
	...
	"github.com/laravel-go-version/v2/pkg/Illuminate/Support/file"
...
func (receiver *MakeCommand) Extend() myco.Extend {
	return myco.Extend{
		Category: "make",
	}
}
...
func (receiver *MakeCommand) Handle(ctx myco.IContext) error {
	name := ctx.Argument(0)
	if name == "" {
