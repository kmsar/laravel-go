...
type IHttpRequest interface {
	...
	//ExistsQueryKey(key string) bool
	////	FormFile(key string) (*Upload.UploadFile, error)
	//FormFiles() (map[string]*Upload.UploadFile, error)
