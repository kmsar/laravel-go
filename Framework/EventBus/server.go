...
// SubscribeArg - object to hold subscribe arguments from remote event subscribers
...
// Server - object capable of being subscribed to by remote subscribers
type Server struct {
	eventBus    Bus
	address     string
	path        string
...
func (server *Server) rpcCallback(subscribeArg *SubscribeArg) EventCallbackFunc {
	return func(e *Event) {
