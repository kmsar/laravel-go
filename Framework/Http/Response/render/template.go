...
type Renderer interface {
	...
	Render(io.Writer, interface{}, application.Context, ...string) error
...
func (r *innerRenderer) Render(w io.Writer, data interface{}, ctx application.Context, tpl ...string) error {
	if len(tpl) <= 0 {
